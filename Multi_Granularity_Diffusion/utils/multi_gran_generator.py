...
def creat_coarse_data(mg_dict, dataset_train, dataset_test):
    ...
    if dataset_train is not None:
        ...
        dataDict_train_coarse['hidden_state_1'] = dataDict['hidden_state_1']
        dataDict_train_coarse['hidden_state_2'] = dataDict['hidden_state_2']
    ...
    if data_test is not None:
        ...
        dataDict_test_coarse['hidden_state_1'] = dataDict['hidden_state_1']
        dataDict_test_coarse['hidden_state_2'] = dataDict['hidden_state_2']
